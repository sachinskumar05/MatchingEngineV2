 ...
 * {@link CopyCtorAndArgsProvider#getForContext(ConstructionContext)} method.
 * <p>
 * If the source element being copied is itself an instance of {@link StructuredArray}, the
 * source element will be passed through as a contextCookie in the outgoing {@link CtorAndArgs},
 ...
 * <p>
 * {@link CopyCtorAndArgsProvider} will attempt to efficiently recycle {@link CtorAndArgs}
 * instances and to avoid per-element allocation of new {@link CtorAndArgs} instances by caching
