...
/**
 * A subclassable array of floats. This protected variant keeps access to the subclassed array protected
 * such that inheriting classes can avoid unintentional exposure of the array and its contents to their users.
 *
 * {@link ProtectedPrimitiveFloatArray} is designed with semantics specifically chosen and restricted such that a
...
public class ProtectedPrimitiveFloatArray extends AbstractPrimitiveFloatArray {
     ...
     */
    protected float[] asArray() throws IllegalStateException {
        return _asArray();
    }
     ...
     * @return the value of the element at the given index
     */
    protected float get(final long index) {
        return _get(index);
    }
     ...
     * @param value the value to assign to the element
     */
    protected void set(final long index, final float value) {
        _set(index, value);
    }
     ...
     * Default constructor
     */
    protected ProtectedPrimitiveFloatArray() {
        super();
    }
     ...
     */
    protected ProtectedPrimitiveFloatArray(ProtectedPrimitiveFloatArray sourceArray) {
        super(sourceArray);
    }

    /**
     * Create a new instance of {@link ProtectedPrimitiveFloatArray} with a given length.
     *
     * @param length the length of the array.
     * @return a new instance of {@link ProtectedPrimitiveFloatArray} with the given length
     */
    protected static ProtectedPrimitiveFloatArray newInstance(final long length) {
        return AbstractPrimitiveArray._newInstance(noLookup, ProtectedPrimitiveFloatArray.class, length);
    }

    /**
     * Create a new instance of &lt;A extends {@link ProtectedPrimitiveFloatArray}&gt; with a given length.
     *
     ...
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveFloatArray}&gt; with a given length
     */
    protected static <A extends ProtectedPrimitiveFloatArray> A newInstance(
     ...
     * @param <A> The class of the array to be created (extends PrimitiveFloatArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveFloatArray}&gt;
     */
    protected static <A extends ProtectedPrimitiveFloatArray> A newInstance(
    ...
    /**
     * Create a new &lt;A extends {@link ProtectedPrimitiveFloatArray}&gt; instance, using a copy constructor to
     * replicate the contents of the given source array
     * @param source The array to replicate
     * @param <A> The class of the array to be created (extends PrimitiveFloatArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveFloatArray}&gt; copied from the source array
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveFloatArray> A copyInstance(A source) throws NoSuchMethodException {
     ...
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveFloatArray> A copyInstance(
            MethodHandles.Lookup lookup,
