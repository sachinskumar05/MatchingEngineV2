...
/**
 * A subclassable array of chars. This protected variant keeps access to the subclassed array protected
 * such that inheriting classes can avoid unintentional exposure of the array and its contents to their users.
 *
 * {@link ProtectedPrimitiveCharArray} is designed with semantics specifically chosen and restricted such that a
...
public class ProtectedPrimitiveCharArray extends AbstractPrimitiveCharArray {
     ...
     */
    protected char[] asArray() throws IllegalStateException {
        return _asArray();
    }
     ...
     */
    protected void set(final int index, final char value) {
        _set(index, value);
    }
     ...
     * @param value the value to assign to the element
     */
    protected void set(final long index, final char value) {
        _set(index, value);
    }
     ...
     * Default constructor
     */
    protected ProtectedPrimitiveCharArray() {
        super();
    }
     ...
     */
    protected ProtectedPrimitiveCharArray(ProtectedPrimitiveCharArray sourceArray) {
        super(sourceArray);
    }

    /**
     * Create a new instance of {@link ProtectedPrimitiveCharArray} with a given length.
     *
     * @param length the length of the array.
     * @return a new instance of {@link ProtectedPrimitiveCharArray} with the given length
     */
    protected static ProtectedPrimitiveCharArray newInstance(final long length) {
        return AbstractPrimitiveArray._newInstance(noLookup, ProtectedPrimitiveCharArray.class, length);
    }

    /**
     * Create a new instance of &lt;A extends {@link ProtectedPrimitiveCharArray}&gt; with a given length.
     *
     ...
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveCharArray}&gt; with a given length
     */
    protected static <A extends ProtectedPrimitiveCharArray> A newInstance(
     ...
     * @param <A> The class of the array to be created (extends PrimitiveCharArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveCharArray}&gt;
     */
    protected static <A extends ProtectedPrimitiveCharArray> A newInstance(
    ...
    /**
     * Create a new &lt;A extends {@link ProtectedPrimitiveCharArray}&gt; instance, using a copy constructor to
     * replicate the contents of the given source array
     * @param source The array to replicate
     * @param <A> The class of the array to be created (extends PrimitiveCharArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveCharArray}&gt; copied from the source array
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveCharArray> A copyInstance(A source) throws NoSuchMethodException {
     ...
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveCharArray> A copyInstance(
            MethodHandles.Lookup lookup,
