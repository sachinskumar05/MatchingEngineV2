...
/**
 * A subclassable array of bytes. This protected variant keeps access to the subclassed array protected
 * such that inheriting classes can avoid unintentional exposure of the array and its contents to their users.
 *
 * {@link ProtectedPrimitiveByteArray} is designed with semantics specifically chosen and restricted such that a "flat"
...
public class ProtectedPrimitiveByteArray extends AbstractPrimitiveByteArray {
     ...
     */
    protected byte[] asArray() throws IllegalStateException {
        return _asArray();
    }
     ...
     * @return the value of the element at the given index
     */
    protected byte get(final long index) {
        return _get(index);
    }
     ...
     * @param value the value to assign to the element
     */
    protected void set(final long index, final byte value) {
        _set(index, value);
    }
     ...
     * Default constructor
     */
    protected ProtectedPrimitiveByteArray() {
        super();
    }
     ...
     */
    protected ProtectedPrimitiveByteArray(ProtectedPrimitiveByteArray sourceArray) {
        super(sourceArray);
    }

    /**
     * Create a new instance of {@link ProtectedPrimitiveByteArray} with a given length.
     *
     * @param length the length of the array.
     * @return a new instance of {@link ProtectedPrimitiveByteArray} with the given length
     */
    protected static ProtectedPrimitiveByteArray newInstance(final long length) {
        return AbstractPrimitiveArray._newInstance(noLookup, ProtectedPrimitiveByteArray.class, length);
    }

    /**
     * Create a new instance of &lt;A extends {@link ProtectedPrimitiveByteArray}&gt; with a given length.
     *
     ...
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveByteArray}&gt; with a given length
     */
    protected static <A extends ProtectedPrimitiveByteArray> A newInstance(
     ...
     * @param <A> The class of the array to be created (extends PrimitiveByteArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveByteArray}&gt;
     */
    protected static <A extends ProtectedPrimitiveByteArray> A newInstance(
    ...
    /**
     * Create a new &lt;A extends {@link ProtectedPrimitiveByteArray}&gt; instance, using a copy constructor to
     * replicate the contents of the given source array
     * @param source The array to replicate
     * @param <A> The class of the array to be created (extends PrimitiveByteArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveByteArray}&gt; copied from the source array
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveByteArray> A copyInstance(A source) throws NoSuchMethodException {
     ...
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveByteArray> A copyInstance(
            MethodHandles.Lookup lookup,
