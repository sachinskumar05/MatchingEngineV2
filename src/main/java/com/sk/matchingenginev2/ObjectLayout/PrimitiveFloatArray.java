 ...
 *
 * {@link PrimitiveFloatArray} is designed with semantics specifically chosen and restricted such that a "flat" memory
...
public class PrimitiveFloatArray extends AbstractPrimitiveFloatArray {
    ...
    public static PrimitiveFloatArray newInstance(final long length) {
        return AbstractPrimitiveArray._newInstance(noLookup, PrimitiveFloatArray.class, length);
    }

    /**
     * Create a new instance of &lt;A extends {@link PrimitiveFloatArray}&gt; with a given length.
     *
     ...
     * @return a new instance of &lt;A extends {@link PrimitiveFloatArray}&gt; with a given length
     */
     ...
     * @param <A> The class of the array to be created (extends PrimitiveFloatArray)
     * @return a new instance of &lt;A extends {@link PrimitiveFloatArray}&gt;
     */
    public static <A extends PrimitiveFloatArray> A newInstance(
    ...
    /**
     * Create a new &lt;A extends {@link PrimitiveFloatArray}&gt; instance, using a copy constructor to
     * replicate the contents of the given source array
     * @param source The array to replicate
     * @param <A> The class of the array to be created (extends PrimitiveFloatArray)
     * @return a new instance of &lt;A extends {@link PrimitiveFloatArray}&gt; copied from the source array
     ...
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    public static <A extends PrimitiveFloatArray> A copyInstance(
            MethodHandles.Lookup lookup,
