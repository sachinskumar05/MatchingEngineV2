...
/**
 * A subclassable array of doubles. This protected variant keeps access to the subclassed array protected
 * such that inheriting classes can avoid unintentional exposure of the array and its contents to their users.
 *
 * {@link ProtectedPrimitiveDoubleArray} is designed with semantics specifically chosen and restricted such that
...
public class ProtectedPrimitiveDoubleArray extends AbstractPrimitiveDoubleArray {
     ...
     */
    protected double[] asArray() throws IllegalStateException {
        return _asArray();
    }
     ...
     * @return the value of the element at the given index
     */
    protected double get(final long index) {
        return _get(index);
    }
     ...
     * @param value the value to assign to the element
     */
    protected void set(final long index, final double value) {
        _set(index, value);
    }
     ...
     * Default constructor
     */
    protected ProtectedPrimitiveDoubleArray() {
        super();
    }
     ...
     */
    protected ProtectedPrimitiveDoubleArray(ProtectedPrimitiveDoubleArray sourceArray) {
        super(sourceArray);
    }

    /**
     * Create a new instance of {@link ProtectedPrimitiveDoubleArray} with a given length.
     *
     * @param length the length of the array.
     * @return a new instance of {@link ProtectedPrimitiveDoubleArray} with the given length
     */
    protected static ProtectedPrimitiveDoubleArray newInstance(final long length) {
        return AbstractPrimitiveArray._newInstance(noLookup, ProtectedPrimitiveDoubleArray.class, length);
    }

    /**
     * Create a new instance of &lt;A extends {@link ProtectedPrimitiveDoubleArray}&gt; with a given length.
     *
     ...
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveDoubleArray}&gt; with a given length
     */
    protected static <A extends ProtectedPrimitiveDoubleArray> A newInstance(
     ...
     * @param <A> The class of the array to be created (extends PrimitiveDoubleArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveDoubleArray}&gt;
     */
    protected static <A extends ProtectedPrimitiveDoubleArray> A newInstance(
    ...
    /**
     * Create a new &lt;A extends {@link ProtectedPrimitiveDoubleArray}&gt; instance, using a copy constructor to
     * replicate the contents of the given source array
     * @param source The array to replicate
     * @param <A> The class of the array to be created (extends PrimitiveDoubleArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveDoubleArray}&gt; copied from the source array
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveDoubleArray> A copyInstance(A source) throws NoSuchMethodException {
     ...
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveDoubleArray> A copyInstance(
            MethodHandles.Lookup lookup,
