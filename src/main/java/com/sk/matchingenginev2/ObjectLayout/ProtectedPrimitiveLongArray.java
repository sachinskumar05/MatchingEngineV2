...
/**
 * A subclassable array of longs. This protected variant keeps access to the subclassed array protected
 * such that inheriting classes can avoid unintentional exposure of the array and its contents to their users.
 *
 * {@link ProtectedPrimitiveLongArray} is designed with semantics specifically chosen and restricted such that a
...
public class ProtectedPrimitiveLongArray extends AbstractPrimitiveLongArray {
     ...
     * @return the value of the element at the given index
     */
    protected long get(final long index) {
        return _get(index);
    }
     ...
     * @param value the value to assign to the element
     */
    protected void set(final long index, final long value) {
        _set(index, value);
    }
     ...
     * Default constructor
     */
    protected ProtectedPrimitiveLongArray() {
        super();
    }
     ...
     */
    protected ProtectedPrimitiveLongArray(ProtectedPrimitiveLongArray sourceArray) {
        super(sourceArray);
    }

    /**
     * Create a new instance of {@link ProtectedPrimitiveLongArray} with a given length.
     *
     * @param length the length of the array.
     * @return a new instance of {@link ProtectedPrimitiveLongArray} with the given length
     */
    protected static ProtectedPrimitiveLongArray newInstance(final long length) {
        return AbstractPrimitiveArray._newInstance(noLookup, ProtectedPrimitiveLongArray.class, length);
    }

    /**
     * Create a new instance of &lt;A extends {@link ProtectedPrimitiveLongArray}&gt; with a given length.
     *
     ...
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveLongArray}&gt; with a given length
     */
    protected static <A extends ProtectedPrimitiveLongArray> A newInstance(
     ...
     * @param <A> The class of the array to be created (extends PrimitiveLongArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveLongArray}&gt;
     */
    protected static <A extends ProtectedPrimitiveLongArray> A newInstance(
    ...
    /**
     * Create a new &lt;A extends {@link ProtectedPrimitiveLongArray}&gt; instance, using a copy constructor to
     * replicate the contents of the given source array
     * @param source The array to replicate
     * @param <A> The class of the array to be created (extends PrimitiveLongArray)
     * @return a new instance of &lt;A extends {@link ProtectedPrimitiveLongArray}&gt; copied from the source array
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveLongArray> A copyInstance(A source) throws NoSuchMethodException {
     ...
     * @throws NoSuchMethodException if &lt;A&gt; does not have a copy constructor
     */
    protected static <A extends ProtectedPrimitiveLongArray> A copyInstance(
            MethodHandles.Lookup lookup,
