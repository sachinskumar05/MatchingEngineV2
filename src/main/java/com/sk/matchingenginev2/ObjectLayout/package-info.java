...
/**
 * <h3>com.sk.matchingenginev2.ObjectLayout: An optimised memory layout package.</h3>
 * <p>
 * The com.sk.matchingenginev2.ObjectLayout package provides some key data structure classes designed with optimised memory layout
 ...
 * <p>
 * The {@link com.sk.matchingenginev2.ObjectLayout.StructuredArray} class is a good example of this design pattern.
 ...
 * <p>
 * The three commonly used C-style container layout forms that com.sk.matchingenginev2.ObjectLayout seeks to enable in Java are:
 * <ul>
 ...
 * </ol>
 * <h3>The matching com.sk.matchingenginev2.ObjectLayout forms</h3>
 * <p>
 * {@link com.sk.matchingenginev2.ObjectLayout.StructuredArray} provides an idiomatic Java collection form
 * with speed (and semantics) similar to an "array of structs" form, supporting any constructable
 * java Object as an array member.
 * <p>
 * {@link com.sk.matchingenginev2.ObjectLayout.Intrinsic @Intrinsic} provides an idiomatic Java means for declaring
 * member objects that are intrinsic to the instances of the class they are declared in.
 * {@link com.sk.matchingenginev2.ObjectLayout.Intrinsic @Intrinsic} provides a "struct in struct" equivalent
 ...
 * <p>
 * Sub-classable Primitive and Reference array classes (e.g. {@link com.sk.matchingenginev2.ObjectLayout.PrimitiveLongArray}
 * and {@link com.sk.matchingenginev2.ObjectLayout.ReferenceArray}) provide an idiomatic Java means of
 ...
 * in Java. {@link com.sk.matchingenginev2.ObjectLayout.StructuredArray} similarly supports this capability (via
