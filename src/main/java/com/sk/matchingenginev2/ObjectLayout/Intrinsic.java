...
/**
 * The {@link Intrinsic @Intrinsic} annotation defines a declared object field to be
 ...
 * faster, and avoids certain de-referencing steps. {@link Intrinsic @Intrinsic} fields
 * must be declared private and final.
 * <p>
 * Fields annotated with {@link Intrinsic @Intrinsic} SHOULD be initialized using
 * one of the {@link IntrinsicObjects#constructWithin(MethodHandles.Lookup, String, Object)
 * IntrinsicObjects.constructWithin()}
 * variants.
 * <p>
 * An {@link Intrinsic @Intrinsic} field that is NOT initialized using one of
