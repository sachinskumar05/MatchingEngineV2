 ...
 * <p>
 * {@link PrimitiveArrayBuilder} follows the commonly used builder pattern, and is useful for
 * capturing the instantiation parameters of {@link StructuredArray}s.
 * </p>
 * <p>
 * {@link PrimitiveArrayBuilder}s can be created for "flat" and "nested" {@link StructuredArray}
 ...
 * </p>
 * A simple example of using a {@link PrimitiveArrayBuilder} to instantiate a PrimitiveLongArray is:
 * <blockquote><pre>
...
public class PrimitiveArrayBuilder<S extends AbstractPrimitiveArray> {
    ...
    /**
     * Constructs a new {@link PrimitiveArrayBuilder} object for creating arrays of
