package com.sk.matchingenginev2.ds;/*
 * Written by Gil Tene, Martin Thompson and Michael Barker, and released 
 * to the public domain, as explained at:
 * http://creativecommons.org/publicdomain/zero/1.0/
 */

import com.sk.matchingenginev2.ObjectLayout.ReferenceArray;
import com.sk.matchingenginev2.ObjectLayout.StructuredArray;
...
public class BPlusTree<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public static class Leaf extends StructuredArray<Entry> implements Node {
        private int size = 0;
